      ...
      <div className="glass-panel p-8">
        <div className="flex flex-wrap items-start gap-6">
          ...
          <Link
            ...
            className="cta-glow-orange glow-orange shrink-0 rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-orange-500"
          >
            Predict Fight →
          </Link>
        </div>
